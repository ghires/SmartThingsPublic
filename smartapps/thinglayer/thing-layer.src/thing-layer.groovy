...
private logField(evt, Closure c) {
    ...
    httpPostJson(uri: "https://thinglayer-gjh.firebaseIO.com/events/${evt.deviceId}/${evt.name}.json",   body:[device: evt.deviceId, name: evt.name, value: evt.value, date: evt.isoDate, unit: evt.unit]) {
